...
def get_argument_parser():
    ...
    parser.add_argument('--calico_solo', dest='hashsolo_out', help="Path "
    "to cached output of hashsolo(h5ad)"
    )
    parser.add_argument('--vireo_out', help="Path to cached output of "
    "hashsolo(h5ad)"
    )
    parser.add_argument('-m', '--max_mito', type=int, help="Max "
    "mitochondrial genes(in percent) per cell. Default: 5", 
    default=5
    )
    parser.add_argument('-g', '--min_genes', type=int, help="Min #genes "
    "per cell. Default: 1000", default=1000
    )
    parser.add_argument('-c', '--min_cells', type=int, help="Min #cells "
    "expressing a gene for it to pass the filter. Default: 10", default=10
    )
    parser.add_argument('--columns', nargs=4, help="List of column names "
    ...
    parser.add_argument('--hto_sep', help="If, per each sample in the "
