...
parser.add_argument('-e', '--extra', help="Classficiation used when a cell is not present in the classification by hashsolo. Default: Not Present", default='Not Present')
...
adata=adata[(adata.obs[args.column].str.lower != args.doublet.lower()) & (adata.obs[args.column].str.lower != args.negative.lower()) & (adata.obs[args.column].str.lower != args.extra.lower())].copy()
