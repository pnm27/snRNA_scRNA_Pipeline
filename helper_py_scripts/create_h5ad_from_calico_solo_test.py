...
hash_data = ad.read("/sc/arion/projects/psychAD/pnm/cache/round3_Sample-NPSAD-20201218-A1-cDNA.h5ad")
...
hash_data.write("/sc/arion/projects/psychAD/pnm/r3_20201218-A1_calicosolo_out.h5ad")
...
adata = sc.read_10x_mtx('/sc/arion/projects/psychAD/STARsolo_bams/round3/Sample_NPSAD-20201218-A1-cDNA/NPSAD-20201218-A1-cDNA_L003_001_Solo.out/GeneFull/filtered_Lun/matrix.mtx.gz'[:-13], make_unique=True, var_names= "gene_ids", cache=True)
solo_run_info = []
...
solo_run_df.to_csv("/sc/arion/projects/psychAD/pnm/test_calicosolo_info.tsv", sep = "\t", index=False)
#solo_run_df.to_csv(snakemake.output[2], sep = "\t", index=False)

adata.write("/sc/arion/projects/psychAD/pnm/test_calicosolo_out.h5ad")
