...
sleep 20
samtools index "${4}${1}.bam" &> /dev/null && rm "${3}${1}.bam" "${3}${1}.bam.bai" && (echo -n "Number of reads after filtering mito reads for the donor ${1}: " ; samtools view -c "${4}${1}.bam") && exit 0 || exit 1
